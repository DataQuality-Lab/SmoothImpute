...
class GNNStack(torch.nn.Module):
    def __init__(self, 
        ...
        # print(f"node_input_dim is {node_input_dim}, edge_input_dim is {edge_input_dim}, node_dim is {node_dim}, edge_dim is {edge_dim}, edge_mode is {edge_mode}, model_types is {model_types}.")
        # convs
